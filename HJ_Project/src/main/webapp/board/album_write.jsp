...
<head>
	...
	<title>IT HILLSTATE - Album Write</title>
	<!-- Favicon-->
...
%>
	...
	<main class="container-sm">	
		<form action="album_writePro.jsp" method="post" enctype="multipart/form-data" style="margin-top: 50px;">
			<div>
				<input type="text" name="name" class="form-control" value="<%=id %>"  required="required"> 
