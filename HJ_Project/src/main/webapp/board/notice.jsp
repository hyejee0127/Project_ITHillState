...
<head>
	...
	<title>IT HILLSTATE - Notice</title>
	<!-- Favicon-->
...
ArrayList<NoticeBoardDTO> boardList = dao.selectBoardList(startRow, listLimit);
...
int count = reply.replyCount(board.getNum(), "notice");
%>
			<!-- 반복문 내에서 각 레코드를 각 행에 표시 -->
			<!-- 	<tbody class="table-striped"> -->
				<tr onclick="location.href='notice_content.jsp?num=<%=board.getNum()%>'" style="cursor:pointer;">
	...
	<br><br>
		<div style="text-align: center;">
			<ul class="pagination" style="display: inline-block;">
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">				
						<a class="page-link" href="notice.jsp?pageNum=<%=pageNum - 1%>" style="color: black;">&laquo;</a>
					</li>
				<%} %>
				...
				<%for(int i = startPage; i <= endPage; i++) { %>
					...
					<%} else { %>
						<a class="page-link" href="notice.jsp?pageNum=<%=i %>" style="color: black;"><%=i %></a>
					<%} %>
						</li>
				<%} %>
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">
						<a class="page-link" href="notice.jsp?pageNum=<%=pageNum + 1%>" style="color: black;">&raquo;</a>
					</li>
				<%} %>
			</ul>
		</div>
