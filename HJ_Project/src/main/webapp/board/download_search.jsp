...
<head>
	...
	<title>IT HILLSTATE - Download Search</title>
	<!-- Favicon-->
...
ArrayList<FileBoardDTO> boardList = dao.selectBoardList(startRow, listLimit, searchSelect, keyword);
...
%>
				...
				<tr onclick="location.href='download_content.jsp?num=<%=board.getNum()%>'">
...
%>
		...
		<div style="text-align: center;">
			<ul class="pagination" style="display: inline-block;">
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">				
						<a class="page-link" href="download_search.jsp?keyword=<%=keyword%><%=pageNum - 1%>" style="color: black;">&laquo;</a>
					</li>
				<%} %>
				...
				<%for(int i = startPage; i <= endPage; i++) { %>
					...
					<%} else { %>
						<a class="page-link" href="download_search.jsp?keyword=<%=keyword%><%=i %>" style="color: black;"><%=i %></a>
					<%} %>
						</li>
				<%} %>
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">
						<a class="page-link" href="download_search.jsp?keyword=<%=keyword %><%=pageNum + 1%>" style="color: black;">&raquo;</a>
					</li>
				<%} %>
			</ul>
		</div>
