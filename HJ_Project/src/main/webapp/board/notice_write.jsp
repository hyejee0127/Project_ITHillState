...
<head>
	...
	<title>IT HILLSTATE - Notice Write</title>
	<!-- Favicon-->
...
<%
// 세션에 저장된 아이디가 null 이면 자바스크립트를 통해 "관리자만 접근 가능합니다" 출력 후 돌아가기
...
%>
	...
	<main class="container-sm">	
		<form action="notice_writePro.jsp" method="post" style="margin-top: 50px;">
			<div>
