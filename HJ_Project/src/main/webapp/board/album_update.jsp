...
<head>
	...
	<title>IT HILLSTATE - Album Update</title>
	<!-- Favicon-->
...
<body class="d-flex flex-column min-vh-100">
	...
	<main class="container-sm">	
		<form action="album_updatePro.jsp" method="post" enctype="multipart/form-data" style="margin-top: 50px;">
			<!-- 입력받지 않은 글번호도 함께 전달 -->
			<input type="hidden" name="num" value="<%=request.getParameter("num")%>">
			<!-- 기존 파일 삭제를 위해 실제 업로드 파일명도 함께 전달 -->
			<input type="hidden" name="real_imgfile" value="<%=board.getReal_imgfile()%>">
			<div>
			...
			<div class="form-group">
				<%=board.getOriginal_imgfile() %>
				<input class="form-control" type="file" name="original_imgfile" id="formFile">
    		</div>
			<br>
