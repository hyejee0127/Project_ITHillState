...
<head>
	...
	<title>IT HILLSTATE - Album</title>
	<!-- Favicon-->
...
ArrayList<AlbumBoardDTO> boardList = dao.selectBoardList(startRow, listLimit);
...
// int count = reply.replyCount(board.getNum(), "album");
%>
			<!-- 반복문 내에서 각 레코드를 각 행에 표시 -->
					<div class="col">
						<div class="card shadow-sm">
							<a onclick="location.href='album_content.jsp?num=<%=board.getNum()%>'" style="cursor:pointer;">
	...
	<div>
		...
		<div style="text-align: center;">
			<ul class="pagination" style="display: inline-block;">
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">				
						<a class="page-link" href="album.jsp?pageNum=<%=pageNum - 1%>" style="color: black;">&laquo;</a>
					</li>
				<%} %>
				...
				<%for(int i = startPage; i <= endPage; i++) { %>
					...
					<%} else { %>
						<a class="page-link" href="album.jsp?pageNum=<%=i %>" style="color: black;"><%=i %></a>
					<%} %>
						</li>
				<%} %>
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">
						<a class="page-link" href="album.jsp?pageNum=<%=pageNum + 1%>" style="color: black;">&raquo;</a>
					</li>
				<%} %>
			</ul>
		</div>
