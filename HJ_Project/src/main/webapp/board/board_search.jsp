...
<head>
	...
	<title>IT HILLSTATE - Search</title>
	<!-- Favicon-->
...
<body class="d-flex flex-column min-vh-100">
	...
	<h3>자유게시판</h3>
		<article>	
			<form style="width: 60%; float: right;" action="board_search.jsp" method="get">
...
ArrayList<BoardDTO> boardList = dao.selectBoardList(startRow, listLimit, searchSelect, keyword);
...
%>
				...
				<tr onclick="location.href='board_content.jsp?num=<%=board.getNum()%>'">
...
%>
		...
		<div style="text-align: center;">
			<ul class="pagination" style="display: inline-block;">
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">				
						<a class="page-link" href="board_search.jsp?keyword=<%=keyword%><%=pageNum - 1%>" style="color: black;">&laquo;</a>
					</li>
				<%} %>
				...
				<%for(int i = startPage; i <= endPage; i++) { %>
					...
					<%} else { %>
						<a class="page-link" href="board_search.jsp?keyword=<%=keyword%><%=i %>" style="color: black;"><%=i %></a>
					<%} %>
						</li>
				<%} %>
				...
				<%} else { %>
					<li class="page-item" style="display: inline-block;">
						<a class="page-link" href="board_search.jsp?keyword=<%=keyword %><%=pageNum + 1%>" style="color: black;">&raquo;</a>
					</li>
				<%} %>
			</ul>
		</div>
